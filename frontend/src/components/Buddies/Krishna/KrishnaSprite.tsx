      ...
      <div className={`${styles.krishna} ${getStateClass()}`}>
        ...
        >
          ...
          <g id="headGroup" transform="translate(0, -20)">
            {/* Front Side Wisps Framing Cheeks */}
            <g id="hairSides">
            ...
            <g id="faceDetails">
              ...
              {/* ── Delicate White Devotional Dots Over Eyebrows (Chandan Bindi Makeup) ── */}
              <g id="eyebrowDots" fill="#FFFFFF" opacity="0.95">
                {/* Left eyebrow makeup dots */}
                <circle cx="132" cy="130" r="1.3" />
                <circle cx="140" cy="126" r="1.4" />
                <circle cx="148" cy="124" r="1.5" />
                <circle cx="156" cy="124" r="1.5" />
                <circle cx="164" cy="126" r="1.4" />
                <circle cx="172" cy="130" r="1.3" />

                {/* Right eyebrow makeup dots */}
                <circle cx="208" cy="130" r="1.3" />
                <circle cx="216" cy="126" r="1.4" />
                <circle cx="224" cy="124" r="1.5" />
                <circle cx="232" cy="124" r="1.5" />
                <circle cx="240" cy="126" r="1.4" />
                <circle cx="248" cy="130" r="1.3" />
              </g>
          ...
          <g id="sudarshanChakraMaster" transform="translate(91, 56)" filter="url(#kChakraGlowFilter)">
            {/* Divine Golden Radial Glow Aura */}
            <ellipse cx="0" cy="0" rx="50" ry="24" fill="url(#kChakraAura)" />

            {/* 3D Horizontally Oriented Perspective Container */}
            <g transform="scale(1, 0.48)">
              {/* Perfectly Centered Rotating Chakra Disc */}
              <g className={styles.chakraDisc}>
                ...
                <circle cx="0" cy="0" r="42" fill="url(#kChakraCore)" opacity="0.25" />
                {/* Heavy Solid Metallic Gold Outer Rim */}
                <circle cx="0" cy="0" r="40" fill="none" stroke="url(#kGoldGrad)" strokeWidth="7.5" />
                {/* Inner Polished Gold Beaded Track */}
                <circle cx="0" cy="0" r="32" fill="none" stroke="#FFFBEB" strokeWidth="2.2" opacity="0.9" />
                <circle cx="0" cy="0" r="24" fill="none" stroke="url(#kGoldGrad)" strokeWidth="3.0" opacity="0.75" />

                {/* Central Sacred Golden Hub */}
                <circle cx="0" cy="0" r="13" fill="url(#kChakraCore)" stroke="#92400E" strokeWidth="2.0" />
                <circle cx="0" cy="0" r="4.5" fill="#FFFFF0" />
                <circle cx="-2" cy="-2" r="2.0" fill="#FFFFFF" opacity="0.95" />
                ...
                {[0, 22.5, 45, 67.5, 90, 112.5, 135, 157.5, 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5].map(
                  (angle) => (
                    <g key={angle} transform={`rotate(${angle})`}>
                      <line x1="14" y1="0" x2="33" y2="0" stroke="url(#kGoldGrad)" strokeWidth="3.5" />
                      <path
                        d="M 32 0 L 39 -5 L 46 0 L 39 5 Z"
                        fill="url(#kGoldGrad)"
                        stroke="#B45309"
                        strokeWidth="1.2"
                      />
