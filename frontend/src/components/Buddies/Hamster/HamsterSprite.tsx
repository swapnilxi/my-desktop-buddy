...
export interface HamsterSpriteProps extends BuddySpriteProps {
    ...
    >
      ...
      >
        ...
        <div className="hamster-body-layer">
          {/* Anatomical Hind Feet Emerging Underneath Lower Body (Underneath Layer, Z-INDEX: 1) */}
          ...
          {/* Fleshy Lower Haunches (Rear/Hip Sitting Volume, Z-INDEX: 2) */}
          <div className="hamster-haunches">
            <span className="haunch-lobe haunch-left" />
            <span className="haunch-lobe haunch-right" />
          </div>

          {/* Pear-Shaped Torso Mass with Shoulders and Cream Belly (Z-INDEX: 3) */}
